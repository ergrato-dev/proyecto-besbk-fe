...
>
> **Nota**: El frontend de este proyecto es **idéntico** al de `proyecto-be-fe`.
> Este documento aplica exactamente igual a ambos proyectos.
...
**¿Qué?** Debe existir un mecanismo para saltar bloques repetitivos (la navbar) y
llegar directamente al contenido principal.
...
<div role="group" aria-label="Seleccionar conjunto de datos">
  <button
    aria-pressed={isEmployees}  {/* "activado" o "no activado" */}
...
# blue-600 (#2563eb) sobre white (#ffffff) → ~5.40:1 ✅ AA
# gray-500 (#6b7280) sobre white (#ffffff) → ~4.48:1 ✅ AA (límite)
```
